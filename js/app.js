 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".bottom-page__slider")) new swiper_core_Swiper(".bottom-page__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".bottom-page__arrow-left.swiper-button-prev",
                    nextEl: ".bottom-page__arrow-right.swiper-button-next"
                },
                on: {}
            });
        }
